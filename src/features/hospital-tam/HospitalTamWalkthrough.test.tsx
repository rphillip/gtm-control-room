...
describe('HospitalTamWalkthrough', () => {
  it('moves forward and backward through all entity layers', async () => {
    ...
    expect(screen.getByText(/four grouping cups.*four health-system identities/i)).toBeVisible()
    ...
    expect(screen.getByText(/three account balls strike the counter paddles/i)).toBeVisible()
